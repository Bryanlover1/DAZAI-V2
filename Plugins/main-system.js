...
let handler = async (m, { conn }) => {
  ...
  try {
    let repo_Data = await axios.get('https://api.github.com/repos/Bryanlover1/DAZAI-V2');
    let { stargazers_count, forks, owner, created_at, html_url } = repo_Data.data;

    let infobt = `
🔰 *I'm DAZAI-V2.* *A WhatsApp chuddy buddy bot with rich features* *Created By BRYAN TECH and BRYANT TECH*. 🔰
 ...
 *❲❒❳ Create:* ${created_at} 
 *❲❒❳ Repo:* ${html_url}
 *❲❒❳ Scan:* https://replit.com/@Bryan Tech/DAZAI-V2-PAIRING
 *❲❒❳ Visit For Tutorial:* www.youtube.com/@s4salmanyt
  
🔰 *Created ʙʏ DAZAI TEAM* 🔰
